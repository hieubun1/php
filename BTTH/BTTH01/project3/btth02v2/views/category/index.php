        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="index.php?controller=admin&action=category">Thể loại</a>
                    </li>
                    <li class="nav-item">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?= $row['ten_tloai']?></td>
                            <td>
                                <a href="index.php?controller=category&action=edit&ma_tloai=<?= $row['ma_tloai']?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td>
                                <a href="index.php?controller=category&action=del&ma_tloai=<?= $row['ma_tloai']?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?');"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php endforeach; ?>
