            ...
            <div class="col-sm">
                ...
                <form method="POST">
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="tieude" value="<?= $article['tieude'] ?>" required>
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tên bài hát</span>
                        <input type="text" class="form-control" name="ten_bhat" value="<?= $article['ten_bhat'] ?>" required>
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Mã tác giả</span>
                        <input type="text" class="form-control" name="ma_tgia" value="<?= $article['ma_tgia'] ?>" required>
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Mã thể loại</span>
                        <input type="text" class="form-control" name="ma_tloai" value="<?= $article['ma_tloai'] ?>" required>
                    </div>
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="lblCatName">Tóm tắt</span>
                        <input type="text" class="form-control" name="tomtat" value="<?= $article['tomtat'] ?>" required>
                    </div>
                    <div class="form-group  float-end ">
                        <button type="submit" class="btn btn-primary" name="submit">Lưu</button>
                        <a href="index.php?controller=admin&action=article" class="btn btn-warning ">Quay lại</a>
                    </div>
                </form>
            </div>
        </div>
