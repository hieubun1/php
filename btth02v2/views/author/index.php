        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fw-bold" href="index.php?controller=admin&action=author">Tác giả</a>
                    </li>
                    <li class="nav-item">
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?= $row['ten_tgia']?></td>
                            <td>
                                <a href="index.php?controller=author&action=edit&ma_tgia=<?= $row['ma_tgia']?>"><i class="fa-solid fa-pen-to-square"></i></a>
                            </td>
                            <td>
                                <a href="index.php?controller=author&action=del&ma_tgia=<?= $row['ma_tgia']?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?');"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    </tbody>
                    <?php endforeach; ?>
